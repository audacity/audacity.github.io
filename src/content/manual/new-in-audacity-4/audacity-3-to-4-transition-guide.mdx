...
description: With Audacity 4, we've tried to modernize the app while keeping
  things still feeling Audacity. That said, there are some notable differences.
...
Sync lock has been replaced by ripple editing. You can set your default delete behavior in **Preferences -> Editing**. To make an edit while keeping all tracks in sync, use "**Delete and close gap (all tracks)**" <Shortcut client:load keys="Ctrl+Delete" /> and "**Insert and preserve sync"  <Shortcut client:load keys="Ctrl+Shift+V" />**, respectively. You can edit these shortcuts in preferences.
...
![](https://support.audacityteam.org/~gitbook/image?url=https%3A%2F%2F2905281570-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FEnNXGrLkN0pXlkzzS7cM%252Fuploads%252F3ojmSF8DqrKyMxo7OPwd%252Fgrafik.png%3Falt%3Dmedia%26token%3D785cc4d4-8b29-4f5b-a7b0-3f3ef0afa209&width=768&dpr=3&quality=100&sign=305e4d20&sv=2)
...
We have replaced the following tool modes: Select tool  <Shortcut client:load keys="F1" />, Envelope tool  <Shortcut client:load keys="F2" />, Draw tool <Shortcut client:load keys="F3" />, and Multi-tool  <Shortcut client:load keys="F6" />. Instead, envelopes are a visual layer which can be toggled visible using the Automation button.

![](https://support.audacityteam.org/~gitbook/image?url=https%3A%2F%2F2905281570-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FEnNXGrLkN0pXlkzzS7cM%252Fuploads%252FT7LE9oWGJNtc7tOOYE0A%252Fgrafik.png%3Falt%3Dmedia%26token%3Dbe6021a9-77b9-40a1-beab-4d8a84648b93&width=768&dpr=3&quality=100&sign=411468ab&sv=2)
...
A new tool mode has been added, Split tool. The split tool can be engaged by pressing or holding <Shortcut client:load keys="S" />, and allows you to quickly split clips into two.
