...
<Callout title="No microphone yet?">
  ...
  pages and hear how Audacity behaves. It will sound noticeably worse than
  even an inexpensive external microphone — thinner, more distant, and full
  of the room — so treat it as a way to get started rather than a way to
  record something you intend to publish.
</Callout>
...
<Callout title="Not everything in the list is a microphone">
  ...
  webcams, and virtual devices created by other software, sitting alongside
  the real ones. Choose the entry named after your microphone or interface.
  If two look plausible, record a few seconds with each — the right one is
