...
The panel opens on the left, with a section for each track. Click
**Add effect** to pick from the list, and effects run in the order they are
...
Notice that the waveform does not change: nothing has been written into your
audio, and the effect keeps working after you close its window.
