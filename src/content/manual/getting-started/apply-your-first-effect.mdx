...
Click **Add effect** to pick from the list, and effects run in the order they
are stacked, top to bottom. Notice that the waveform does not change: nothing
has been written into your audio, and the effect keeps working after you close
its window.
