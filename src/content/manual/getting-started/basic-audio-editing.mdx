...
- **Move** a clip by dragging it **by its header**, the strip along the top of
  the clip — along its track, onto another track, or into the empty space
...
change its speed: drag them and the clip stretches or squeezes, playing slower
or faster. A clip whose speed has been changed shows a small badge in its top
...
<Callout type="tip" title="A second is plenty">
  ...
  every pause makes speech sound unnatural and rushed. Remove stumbles and long
  gaps, not the rhythm of talking.
</Callout>
...
just the last change. [Redo](/manual/menu-bar/edit#redo),
