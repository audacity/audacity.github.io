...
<Callout type="info" title="A prompt about folder access">
  The first time you export into a folder like Documents, your computer may
  ask whether Audacity is allowed to access it. Allow it, or the export cannot
  be written there.
</Callout>
...
Exporting in more depth is covered in
