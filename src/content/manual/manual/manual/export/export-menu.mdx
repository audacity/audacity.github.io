...
Dialog menu that allows to configure and perform Export of a given project/file.

![Export Menu](../../../assets/img/manual/manual-index/export-menu/image-9910b0.png)
...
<Notes>
  The default setting for export is Stereo, a pair with left and right channels.
  This also applies even if you only have mono tracks for exporting.&#x20;
</Notes>
