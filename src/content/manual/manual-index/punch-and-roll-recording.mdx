...
Begin recording as usual with the [Transport toolbar](https://manual.audacityteam.org/man/transport_toolbar.html) Record button

![The Record button](https://manual.audacityteam.org/m/images/e/e8/record.png)

, the menu command Transport > Recording > Record, or the keyboard shortcut R key.

If you make a mistake, stop recording with the [Transport toolbar](https://manual.audacityteam.org/man/transport_toolbar.html) Stop button
