...
your headphones on *before* switching on input monitoring, or the microphone
...
<Shortcut client:load keys="cmd+shift+e" /> and choose **MP3** at
**128 kbps**, **mono** for a single voice. If your host publishes its own
guidance on format or loudness, follow that instead. Fill in the metadata —
title, artist and episode number travel with the file and show up in
players.
