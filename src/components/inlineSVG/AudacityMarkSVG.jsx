/*
  The bare Audacity headphone mark (the favicon's paths), for square icon
  slots where the full wordmark lockup doesn't fit — e.g. the help hub's
  Contribute card next to the Discord and GitHub marks. Fill is inherited
  from className so it can sit monochrome beside other brand marks.
*/
const AudacityMarkSVG = ({ className = "h-6 fill-accent" }) => (
  <svg
...
export default AudacityMarkSVG;
