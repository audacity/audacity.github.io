  ...
  return (
    <>
      {showBanner && (
        <div
          id="promo-banner"
          className="flex flex-col sm:flex-row md:justify-center justify-between items-center min-h-24 bg-yellow-300 py-2 gap-4 lg:gap-8 px-4"
        >
          ...
          <a
            ...
            className="flex text-base md:text-lg font-bold h-8 justify-center items-center px-4 border-2 border-gray-900 bg-gray-900 rounded-md hover:bg-yellow-300 text-white hover:text-gray-900 hover:border-gray-900"
          >
            Try For Free
          </a>
        </div>
