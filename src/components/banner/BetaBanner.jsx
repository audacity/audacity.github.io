...
function BetaBanner() {
  return (
    ...
    >
      ...
      <a href="/beta" id="join-button" className="flex text-xl h-12 justify-center items-center px-4 border-2 border-gray-900 rounded-md hover:bg-gray-900 hover:text-white">Join the beta</a>
      <a
