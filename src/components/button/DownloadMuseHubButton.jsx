  ...
  function renderButton(href) {
    return (
      <a
        ...
        className="flex items-center justify-center h-12 lg:h-14 w-fit px-6 lg:px-8 rounded-full bg-accent text-white font-semibold hover:opacity-90 transition-opacity"
        href={href}
      >
