...
function PrimaryDownloadButton() {
  ...
  function renderButton(href, buttonText) {
    return (
      <a
        className="flex h-14 xl:h-16 text-lg xl:text-lg px-4 xl:px-6 w-fit bg-blue-700 hover:bg-blue-600 active:bg-blue-800 text-white items-center gap-x-3 rounded"
        href={href}
      >
