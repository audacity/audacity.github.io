...
function PrimaryDownloadButton() {
  ...
  function renderButton(href, buttonText) {
    return (
      <a
        className="flex h-10 xl:h-16 text-base xl:text-lg px-3 xl:px-6 w-fit bg-blue-700 hover:bg-blue-600 active:bg-blue-800 text-white items-center gap-x-3 rounded mt-8"
        href={href}
      >
