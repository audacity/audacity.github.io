export const releaseData = {
  ...
  win: [
    ...
    },
    {
      ...
      browser_download_url:
        "https://github.com/audacity/audacity/releases/download/Audacity-3.3.3/audacity-win-3.3.3-x32.exe",
      checksum:
        "5557df6b8ae57fc46443f9e85a42bac50fa37456c0757c5569e60430d0e359dc",
      type: ".exe",
    },
    {
      name: "32 bit zip file",
      browser_download_url:
        "https://github.com/audacity/audacity/releases/download/Audacity-3.3.3/audacity-win-3.3.3-x32.zip",
      checksum:
  ...
  lin: [
    {
      ...
      checksum: "a47cb5089e8ebb405f2da1be83630a2bb706df0abc7a48d083894cb809cf4dac",
      type: ".AppImage"
    },
  ],
  src: [
    {
      name: "Source code",
      browser_download_url: "https://github.com/audacity/audacity/archive/refs/tags/Audacity-3.3.3.zip",
      checksum: "46ade56a40e761a247c81fa6dcaec43b2ad103b443412eea17e8e6c462be0ed5",
      type: ".zip"
    },
    {
      name: "Source code",
